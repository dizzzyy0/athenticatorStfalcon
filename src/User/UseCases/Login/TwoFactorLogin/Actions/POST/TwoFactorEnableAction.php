...
final class TwoFactorEnableAction extends AbstractController
{
    ...
    #[Route('/2fa/enable', name: 'enable', methods: ['POST'])]
    public function twoFactorAuthenticationEnable(Request $request): Response
    {
        ...
        $success = $this->twoFactorService->enableTwoFactorAuthentication($uuidId, $password);
        if ($success) {
